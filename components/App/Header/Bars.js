...
function Bars() {
    ...
    return (
        <div className="col-span-1 flex lg:justify-end items-center">
            <div onClick={toggleDrawer} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="col-span-1 p-1 flex flex-col gap-y-[6px] w-[20px] lg:w-[45px] cursor-pointer">
