    ...
    return (
        <section className="p-20">
            <ul className="flex flex-nowrap gap-x-4 w-full overflow-x-scroll no-scrollbar">
                <Link href='/profile'>
                    <li className={`whitespace-nowrap min-w-fit text-center text-2xl text-white py-3 px-5 border-b-[3px] transition-all duration-300 ${pathname === '/profile' ? 'border-red-500' : 'border-gray-800'}`}>
                        Profile Information
                    </li>
                </Link>
